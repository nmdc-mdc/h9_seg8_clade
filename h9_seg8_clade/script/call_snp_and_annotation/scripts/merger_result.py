...
def merge_annotation_result(work_path):
    ...
    output_path = os.path.join(work_path,"annotation_result_table.csv")
    if os.path.exists(output_path):
        os.remove(output_path)

    annotation_results = os.path.join(work_path,"annotation_result")
    result = []
    for file_name in os.listdir(annotation_results):
        file_path = os.path.join(annotation_results,file_name)
...
def merge_snp_result(work_path):
    ...
    output_path = os.path.join(work_path,"snp_reuslt_table.csv")
    if os.path.exists(output_path):
        os.remove(output_path)

    differ_site = os.path.join(work_path,"differ_site")
    result = []
    for file_name in os.listdir(differ_site):
        file_path = os.path.join(differ_site,file_name)
