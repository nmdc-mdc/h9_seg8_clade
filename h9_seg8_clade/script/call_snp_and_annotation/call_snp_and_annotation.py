...
def run_program(input_file_path, work_path, multiprocessing_number, delete, current_path, python, isolate_name,
    ...
    reference_file_path = os.path.join(work_dir, "/h9_seg8_clade/script/call_snp_and_annotation/input")
    ...
    differ_path = os.path.join(script_path, "align_differ_site_snp.py")
    query_ref_file_path = os.path.join(work_path, "praperation")

    query_ref_file_path = os.path.join(query_ref_file_path, "query_seqs")
    ...
    annotation_path = os.path.join(script_path, "snp_annotation.py")
    differ_site_file_path = os.path.join(work_path, "differ_site")
    query_ref_file_path = os.path.join(work_path, "praperation")
    ...
    merge_path = os.path.join(script_path, "merger_result.py")
    ...
    if is_none(delete) and delete == "delete":
        delete_path = os.path.join(script_path, "delete_intermediate_files.py")
